...
const OrderCard = ({ elem }) => {
  ...
  return (
    <div>
      ...
      >
        <a>
          <div className=' flex h-full w-36 cursor-pointer flex-col justify-between rounded-lg border p-4 transition duration-300 ease-in-out hover:scale-105 hover:text-black hover:shadow-md sm:w-full'>
            <div>
              {/* order id */}
