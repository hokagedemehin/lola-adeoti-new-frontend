  ...
  return (
    <div>
      ...
      <div className='mx-auto my-2 flex max-w-screen-xl flex-col sm:mt-10'>
        {/* order ID | Order tags */}
        <div className='flex w-full flex-col space-y-3 space-x-0 pb-5 lg:flex-row lg:space-x-4'>
          {/* order ID */}
          <div className='flex'>
        ...
        <div className='flex w-full flex-col space-y-3 space-x-0 lg:flex-row lg:space-x-4 '>
          ...
          <div className='flex w-full flex-col'>
            <div className='flex space-x-2 pb-4'>
              <span className='text-xl font-bold text-gray-400'>Delivery</span>{' '}
          ...
          <div className='flex w-full flex-col'>
            ...
            <div className='flex space-x-2 pb-2'>
              ...
              <span className='text-xl font-bold text-yellow-600 '>Items</span>
            </div>
            {/* cart details card */}
